...
The core physical layer metrics are enclosed inside an unstructured string column (mac_stats). The ETL layer targets and decodes internal JSON-like key/value structures dynamically without parsing overhead.
...
__results___0_1 __results___1_1
